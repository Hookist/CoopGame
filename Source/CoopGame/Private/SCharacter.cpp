...
ASCharacter::ASCharacter()
{
	...
	WeaponAttachedSocketName = "Weapon_Socket";
}
...
void ASCharacter::BeginPlay()
{
	...
	HealthComponent->OnHealthChanged.AddUniqueDynamic(this, &ASCharacter::HandleOnHealthChanged);
}
...
void ASCharacter::Server_SpawnAndSetWeapon_Implementation(TSubclassOf<ASWeapon> WeaponClass)
{
	// Spawn a default weapon
	FActorSpawnParameters SpawnParams;
	SpawnParams.SpawnCollisionHandlingOverride = ESpawnActorCollisionHandlingMethod::AlwaysSpawn;
